...
@Component({
  selector: 'app-component-seachbar',
  templateUrl: './component-seachbar.page.html',
  styleUrls: ['./component-seachbar.page.scss'],
})
export class ComponentSeachbarPage implements OnInit {
  nome : string ='';
  pessoas : any;
