...
const routes: Routes = [
  ...
  { path: 'componenteNativeTextToSpeech', loadChildren: './componente-native-text-to-speech/componente-native-text-to-speech.module#ComponenteNativeTextToSpeechPageModule' }
